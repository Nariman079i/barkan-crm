"""
Django settings for offermvp project.
...
SECRET_KEY = 'django-insecure-zdjuij+*i-vlidiob0$q=#f$x8bvl*z09jv67-(p@9$7siffq*'
...
EMAIL_HOST_PASSWORD = 'mBkUTVy1nV3UDUbfzxzX'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
